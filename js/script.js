...
const createCard = (item) => {
    ...
    cocktail.innerHTML = `
        ...
        <div class="cocktail__content">
            ...
            <button class="btn cocktail__btn cocktail__btn-add" 
...
const scrollService = {
    ...
    disabledScroll() {
        ...
        document.body.style.cssText = `overflow: hidden; position: fixed; top: -${this.scrollPosition}px; left: 0; height: 100vh; width: 100vw; padding-right: ${window.innerWidth - document.body.offsetWidth}px;`;
    },
    enabledScroll() {
...
const modalController = ({modal, btnOpen, time = 300, open, close }) => {
    ...
    modalElem.setAttribute('style', 'display: flex; visibility: hidden; opacity: 0; transition: opacity ${time}ms ease-in-out');
